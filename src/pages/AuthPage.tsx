    ...
    <div className="max-w-md mx-auto px-4 py-12 space-y-6 animate-in fade-in">
      ...
      <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200 space-y-2 text-xs text-slate-600">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px]">
          <button
            type="button"
            onClick={() => handleQuickLogin('admin@godsfavor.co.ke', 'Admin@2026!')}
            className="p-2 rounded-xl bg-white border border-slate-200 text-left hover:border-emerald-500 transition-colors"
          >
            <span className="font-bold text-slate-900 block">Staff / Admin Login</span>
            <span className="text-slate-500 font-mono">admin@godsfavor.co.ke</span>
          </button>
          <button
            type="button"
            onClick={() => handleQuickLogin('customer@gmail.com', 'Customer@2026!')}
            className="p-2 rounded-xl bg-white border border-slate-200 text-left hover:border-emerald-500 transition-colors"
          >
            <span className="font-bold text-slate-900 block">Customer Account</span>
            <span className="text-slate-500 font-mono">customer@gmail.com</span>
          </button>
        </div>
      </div>
    </div>
